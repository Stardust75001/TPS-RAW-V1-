    ...
    t &&
      ...
      (((n = (function () {
        ...
        function y(t, e, n) {
          ...
          (i
            ? (i.value = n)
            : t.transforms.push({ name: e, value: n, unit: r }),
            Bt(t, t.transforms));
        }
        function ct(t) {
          return (
        ...
        var E =
          ...
          _e = function n(t, r) {
            ...
            return Ft.apply(pn, [r].concat(M(t)));
          },
          Ae = function (t) {
            var e = t.match(/[a-z]+/)[0];
          ...
          Ue = function (t, e) {
            return Fe(t) ? Pe(t, e) : Array.isArray(t) ? ze(t, e) : t === e;
          },
          Fe = function (t) {
            return t === Object(t);
          },
        ...
        var Qe,
          ...
          an = {
            y: function (t, e) {
              return O(t, e.YEAR_SINGULAR, e.YEAR_PLURAL, 10);
            },
            M: function (t, e) {
              return O(t, e.MONTH_SINGULAR, e.MONTH_PLURAL, 12);
            },
            w: function (t, e) {
              return O(t, e.WEEK_SINGULAR, e.WEEK_PLURAL, 52);
            },
            d: function (t, e) {
              return O(t, e.DAY_SINGULAR, e.DAY_PLURAL, 365);
            },
            h: function (t, e) {
              return O(t, e.HOUR_SINGULAR, e.HOUR_PLURAL, 24);
            },
            m: function (t, e) {
              return O(t, e.MINUTE_SINGULAR, e.MINUTE_PLURAL, 60);
            },
            s: function (t, e) {
              return O(t, e.SECOND_SINGULAR, e.SECOND_PLURAL, 60);
            },
            mi: function (t, e) {
              return O(t, e.MILLISECOND_SINGULAR, e.MILLISECOND_PLURAL, 1e3);
            }
          },
          un = {
            value: jt,
              ...
              plugin: {
                add: function (t, e, n) {
                  return "function" == typeof t
                    ? U(t.identifier.type, t.identifier.name, t)
                    : U(t, e, n);
                }
              }
            });
