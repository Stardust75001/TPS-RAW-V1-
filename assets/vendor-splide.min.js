    ...
    tx = Object.freeze({
      ...
      Elements: function n(e, i, r) {
        ...
        function b() {
          ...
          ((o = L("." + nB)),
            ...
            k(p, { root: d, track: o, list: u, slides: h }),
        ...
        function w(n) {
          ...
          (t(h), H(d, g), H(o, $), D([o, u], e), D(d, n ? e : ["style", n4]));
        }
        function P() {
          (H(d, g),
            H(o, $),
            ...
            var A = {
              ...
              mount: function n() {
                (E ||
                  ...
                  z(o, n4, g.slide),
                  z(o, nO, w || nu(g.slideLabel, [e + 1, t.length]))),
                  f(o, "click", i(a, np, A)),
      ...
      Move: function n(t, e, i) {
        ...
        function k(n, e) {
          ...
          return e
            ? ((u = s),
              i.trimSpace && t.is(td) && (u = nr(u, 0, m(h(!0) - p()))),
              u)
            : s;
        }
        function L() {
        ...
        return {
          mount: function n() {
            ((r = e.Transition), u([nf, nm, ng, nh], w));
          },
      ...
      Controller: function n(t, e, r) {
        ...
        function A(n, t) {
          var e,
            ...
            u = D(P + r * (n ? -1 : 1), P, !(s || O()));
          if (-1 === u && E) {
            if (((e = h()), !(1 > nt(e - (i = g(!n)))))) return n ? 0 : o;
          }
          return t ? u : z(u);
        }
        function D(n, e, i) {
      ...
      Autoplay: function n(t, e, i) {
        ...
        function w() {
          h && (_(h, tt, !$), z(h, nO, i.i18n[$ ? "play" : "pause"]));
        }
        function E(n) {
      ...
      Cover: function n(t, e, r) {
        ...
        return {
          mount: function n() {
            r.cover && (o(nS, i(s, !0)), o([nf, ng, nh], i(u, !0)));
          },
          destroy: i(u, !1)
        };
      },
      ...
      LazyLoad: function n(e, r, o) {
        ...
        function $(n, t) {
          var e = n[0],
            i = n[1];
          (H(i.slide, to),
            "error" !== t.type && (W(n[2]), M(e, ""), f(nS, e, i), f(n$)),
            l && m());
        }
        function m() {
          v.length && g(v.shift());
      ...
      Pagination: function n(r, o, u) {
        ...
        function x() {
          (s && (W(b ? e(s.children) : s), H(s, c), t(w), (s = null)),
            a.destroy());
        }
        function S(n) {
          m(">" + n, !0);
      ...
      Wheel: function n(t, e, i) {
        ...
        return {
          mount: function n() {
            i.wheel && r(e.Elements.track, "wheel", u, tg);
          }
        };
      },
      Live: function n(t, e, r) {
        var o = nP(t).on,
          ...
          a = nC(90, i(f, !1));
        function f(n) {
          (z(u, nW, n), n ? (b(u, c), a.start()) : (W(c), a.cancel()));
        }
        function l(n) {
  ...
  var tk = (function () {
    ...
    return (
      ...
      (i.emit = function n(t) {
        var i;
        return (
          (i = this.event).emit.apply(i, [t].concat(e(arguments, 1))),
          this
        );
      }),
