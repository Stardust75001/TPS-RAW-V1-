...
const initPremiumPopup = async () => {
  let e = document.querySelector("#popup-premium-modal");
  if (!e) return;
  let t = bootstrap.Modal.getOrCreateInstance(e);
  if (window.location.href.includes("premium-popup")) {
    t.show();
    return;
  }
  t.show();
...
fetch(
  "https://services.shopiweb.fr/api/licenses/get_by_domain/" +
    Shopify.shop +
    "/premium"
).then(function (e) {
  404 == e.status && initPremiumPopup();
});
